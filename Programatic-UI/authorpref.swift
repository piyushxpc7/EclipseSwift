...
class authorpref: UIViewController, UITableViewDelegate, UITableViewDataSource, AuthorCellDelegate {
    
    var followedAuthors = [String]() // Array to store followed authors
    let authors = [
    ...
    @objc private func continueButtonTapped() {
        ...
        _ = MainTabBarController() // Replace with your actual 5th screen view controller
